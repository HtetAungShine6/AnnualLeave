package com.example.navbar.android.fragments.update
...
class UpdateFragment : Fragment() {
    ...
    private fun updateItem(){
        ...
        if(inputCheck(firstName, lastName, updateAge_et.text)){
            ...
            Toast.makeText(this.requireContext(),"Successfully Updated",Toast.LENGTH_SHORT).show()
    ...
    private fun deleteUser(){
        ...
        builder.setPositiveButton("Yes"){ _ , _ ->
            ...
            Toast.makeText(this.requireContext(),"Successfully Deleted",Toast.LENGTH_SHORT).show()
            findNavController().navigate(R.id.action_updateFragment_to_listFragment)
        }
